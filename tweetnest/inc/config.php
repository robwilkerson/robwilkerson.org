<?php
	...
	$config = array(
		// REQUIRED VALUES ------------------------------------
		"twitter_screenname" => "robwilkerson", // Your Twitter screen name
		...
		"db"                 => array(
			...
			"username"       => "robwilke_twtnst", // The username to log in to your database
			"password"       => "FZG5a66exKkH", // The password to log in to your database
			"database"       => "robwilke_tweetnest", // The database name
		...
		"maintenance_http_password" => "GJh823DZJNh2", 
